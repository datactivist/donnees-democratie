...
::: {.column width="60%"}
![](images/open data buildings.png)
:::
:::::
...
::: {.column width="60%"}
![](images/appsfordemocracycontest.jpg) ![](images/rennes.png){width="375"}
:::
:::::
...
::: {.column width="60%"}
![](images/aquitaine.png){width="485"}
:::
:::::
...
::::: columns
::: {.column width="40%"}
![](images/etude-impact-loi-numerique.png){width="401"}...
:::
...
![](images/namr.png){fig-align="center"}

## Quelques exemples de services nés de l'open data

![](images/delibia.png){fig-align="center"}

## Quelques exemples de services nés de l'open data

![](images/meilleursagents.png){fig-align="center"}

## Quelques exemples de services nés de l'open data

![](images/datapolitics.png){fig-align="center"}
...
![](images/non-users.png){fig-align="center"}
